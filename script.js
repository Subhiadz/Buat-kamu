$(document).ready(function () {
     ...
     */
    var content = [{
        title: "Hallo, Ambar Icah Suryaningrum",
        desc: "Kamu apa kabar? semoga kamu bahagia selalu, aku ada tebak tebakan nih buat kamu, tekan tombol panah dibawah yaa!!!"
    }, {
        title: "Kuda-kuda apa yang bikin seneng?",
        desc: "apa cobaa? tebak dulu baru boleh next slide"
    }, {
       title: "Kudapatkan kamu jadi pacarku",
       desc: "bercandaa kok, tapi kalo serius juga boleh"
    }, {
        title: "Oh iya, Aku mau ngomong sesuatu sama kamu nih",
        desc: "jadi sebenarnya tuh"
    }, {
        title: "I Have Crush On You!!",
        desc: "aku harap kamu notice aku:)"
    }, {
        title: "Maaf ya selama ini aku pendem",
        desc: "aku masih malu soalnya, oh iya aku mau bilang kalo ambar tuh cantik secara kepribadian atau penampilan, semangat terus yaa kamu buat tumbuh jadi lebih baik, semoga kamu dapat mencapai impian yang harapkan, I want to say I love you"
 }];
    var currentPage = 0;
    //generate content
